...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // 4. Seed Categories
        $fiction = Category::create(['name' => 'Fiksi', 'slug' => 'fiksi']);
        $science = Category::create(['name' => 'Sains', 'slug' => 'sains']);
        $tech = Category::create(['name' => 'Teknologi', 'slug' => 'teknologi']);
        $history = Category::create(['name' => 'Sejarah', 'slug' => 'sejarah']);

        // 5. Seed Shelves
        $shelfA = Shelf::create(['name' => 'Rak A-1', 'description' => 'Khusus buku fiksi dan novel']);
        $shelfB = Shelf::create(['name' => 'Rak B-1', 'description' => 'Khusus buku eksakta, sains, dan teknologi']);
        $shelfC = Shelf::create(['name' => 'Rak C-1', 'description' => 'Khusus buku humaniora, sejarah, dan geografi']);
